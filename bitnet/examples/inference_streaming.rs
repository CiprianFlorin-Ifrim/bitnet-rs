...
//
// Usage:
//   cargo run --release --example inference_streaming -- <path-to-gguf> "<prompt>"
//
// Example:
...
use bitnet_rs::{ContextParams, GenerateParams, Model, ModelParams, SamplingStrategy};
